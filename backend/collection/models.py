...
class Period(models.Model):
    ...
    """
        Adjusted save function to give option at ChatGPT auto-response.
        Will only access ChatGPT if generate_description called and there
        does not already exist a description for the Period.
    """
    def save(self, generate_description=False, *args, **kwargs):
        if generate_description and not self.description:
            ...
            response = completion.choices[0].message.content + "\n\nThis description was auto-generated by ChatGPT"
